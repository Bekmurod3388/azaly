        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav w-100 tab ">
                    <button class=" w-25 active tablinks   "  onclick="openCity(event, 'London')">Sotish</button>
                    <button class="w-25 active tablinks " onclick="openCity(event, 'Paris')" >Ombor operatsiyalari</button>
                    <button class=" w-25 active tablinks" onclick="openCity(event, 'german')" >Ma'lumotnoma</button>
                    <button class="w-25 active tablinks" onclick="openCity(event, 'xitay')">Ma'muriyat</button>
                         </div>
            </div>
        </div>
    </nav>
              ...
              <div class="text-black ">
                  <div class="row pt-2">
                      <a   href="#" class=" d-flex text-black menu ">
                          <i class="fas fa-money-check-alt naqd cars text-center pl-4 mt-2"></i>
...
{{--                  <div class="border w-100 p-2  h-100 d-flex">--}}
                          <a   href="#" class=" d-flex text-black menu ">
                          <i class="fas fa-chart-bar cars text-center ml-3 mt-2"></i>
                          <div class="pl-5">
    ...
    <div class="container tabcontent justify-center" id="Paris">
        <div class="row pt-2">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2 " >
                <i class="fas fa-calculator cars text-center ml-4 " ></i>
                <div class="pl-5">
        ...
        <div class="row pt-4">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu ">
                <i class="fas fa-list cars text-center ml-3 mt-2"></i>
                <div class="pl-5">
        ...
        <div class="row pt-2">
            <a   href="#" class="col-md-6 d-flex text-black menu  ">
                <i class="fas fa-fax cars text-center naqd ml-4 mt-2"></i>
...
{{--        </div>--}}
    ...
    <div class="container tabcontent" id="german">
        <div class="row pt-4">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-money-check-alt cars text-center ml-3 mt-2"></i>
                <div class="pl-5">
        ...
        <div class="row pt-2">
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-file-signature cars text-center shartnoma ml-3 mt-2"></i>
                <div class="pl-5">
                    <h2>Shartnoma</h2>
    ...
    <div class="container tabcontent" id="xitay">
        <div class="row pt-2">
            ...
            <a   href="{{ route('admin.warehouses.index') }}" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-warehouse cars text-center naqd pl-3 mt-2"></i>
                <div class="pl-5 " style="margin-left: 1%;">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-signal cars text-center pl-3 mt-2"></i>
                <div class="pl-5">
...
{{--            </a>--}}
            <a   href="#" class="col-md-6 d-flex text-black menu">
                <i class="fas fa-link cars text-center pl-4 mt-2"></i>
                <div class="pl-5">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-gavel cars text-center pl-3 mt-2"></i>
                <div class="pl-5" style="margin-left: 2%">
                    <h2>Xizmat</h2>
...
{{--            </a>--}}
        ...
        <div class="row pt-2">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-user-friends cars text-center naqd pl-3 mt-2"></i>
                <div class="pl-5">
                    <h2>Xodimlar</h2>
