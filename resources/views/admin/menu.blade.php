  ...
  <div class="container tabcontent justify-center nav-link  " id="London">
      <div class="row">
          <div class="col-md-6">
              <div class="text-black ">
                  ...
                  <div class="row pt-2">
                      <a   href="#" class=" d-flex text-black menu ">
                          <i class="fas fa-chart-bar cars text-center pl-4 pt-3"></i>
    ...
    <div class="container tabcontent justify-center" id="Paris">
        <div class="row pt-2">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu">
                <i class="fas fa-archive cars text-center pl-3 pt-3"></i>
                <div class="pl-5 pt-2">
        ...
        <div class="row">
            <a   href="#" class="col-md-6 d-flex text-black menu  ">
                <i class="fas fa-archive cars text-center pl-4 pt-3 "></i>
                <div class="pl-5 pt-2" style="margin-left:-0.3%">
    ...
    <div class="container tabcontent" id="german">
        ...
        <div class="row pt-2">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-ruler cars text-center pt-2"></i>
                <div class="pl-4 ">
                    <h2>Birliklar</h2>
        ...
        <div class="row ">
            <a   href="{{ route('admin.purchases.index') }}" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-handshake cars text-center naqd pl-3 pt-1 "></i>
                <div class="pl-5 ">
                    <h2>Xaridorlar</h2>
            ...
            <a   href="{{ route('admin.sizes.index') }}" class="col-md-6 d-flex text-black menu ">
                <i class="fas fa-child cars text-center  pt-2" style="padding-left: 5.5%;"></i>
                <div class="pl-4" >
                    <h2>Hajmi</h2>
        ...
        <div class="row pt-2">
            ...
            <a   href="{{ route('admin.agent.index') }}" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-people-carry cars text-center  mt-2"></i>
                <div class="pl-4">
                    <h2>Sotuvchilar</h2>
    ...
    <div class="container tabcontent" id="xitay">
        ...
        <div class="row ">
            <a   href="#" class="col-md-6 d-flex text-black menu">
                <i class="fas fa-passport cars text-center pl-4 pt-3"></i>
        ...
        <div class="row ">
            ...
            <a   href="{{ route('admin.roles.index') }}" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-user headset cars text-center pl-4 pt-3"></i>
                <div class="pl-4 pt-2" style="margin-left: 2%">
                    <h2>Boshqaruv</h2>
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-cogs cars text-center pl-3 pt-3"></i>
                <div class="pl-4 pt-2">
                    <h2>Sozlanmalar</h2>
        ...
        <div class="row">
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-money-check-alt cars naqd text-center pl-4 pt-3"></i>
                <div class="pl-4 pt-2">
        ...
        <div class="row ">
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-percent cars pl-4 pt-3"></i>
                <div class="pl-4 pt-2" style="margin-left: 2%">
                    <h2>Aksiyalar</h2>
            ...
            <a   href="#" class="col-md-6 d-flex text-black menu p-2">
                <i class="fas fa-id-badge cars text-center pl-5 pt-3"></i>
                <div class="pl-4 pt-2 ">
