        ...
        <div class="row ">
            ...
            <div class="container tabcontent justify-center nav-link  " id="London">
                ...
                <div class="row pt-2">
                    ...
                    <a href="{{ route('admin.custumer_categories.index') }}" class="col-md-6 d-flex text-black menu ">
                        <i class="menu-icon tf-icons fas fa-list-alt naqd cars text-center pl-4 pt-3"></i>
            ...
            <div class="container tabcontent justify-center" id="Paris">
                <div class="row pt-2">
                    <a href="{{route('admin.purchases.index')}}" class="col-md-6 d-flex text-black menu ">
                        ...
                        <div class="pl-5 pt-2">
                            <h2>Sotib olish</h2>
                            <p>Yetkazib beruvchilardan ish haqi uchun tovarlarni qabul qilishni ro'yxatdan o'tkazish
                                .</p></div>
                    </a>
                ...
                <div class="row pt-4">
                    <a href="#" class="col-md-6 d-flex text-black menu ">
                        ...
                        <div class="pl-4 pt-2" style="margin-left: 1.4%;">
                            ...
                            <p>Nomenklatura ro'yxatini boshqarish va ularning xususiyatlari (narx, shtrix,kodlar va
                                boshqalar)</p>
                        </div>
                    </a>
